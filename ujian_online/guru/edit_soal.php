...
$id = $_GET['id'];
$result = mysqli_query($koneksi, "SELECT * FROM soal WHERE id=$id");
...
if (isset($_POST['update'])) {
    ...
    $query = "UPDATE soal SET pertanyaan='$pertanyaan', pilihan_a='$pilihan_a', pilihan_b='$pilihan_b', pilihan_c='$pilihan_c', pilihan_d='$pilihan_d', jawaban_benar='$jawaban_benar' WHERE id=$id";
            ...
            <div class="col-md-8">
                <div class="card border-0 shadow-sm rounded-3">
                    <div class="card-body p-4">
                        <h4 class="fw-bold text-secondary mb-4">Edit Data Soal</h4>
                        <form action="" method="POST">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="pilihan_a" class="form-control" value="<?= htmlspecialchars($data['pilihan_a']); ?>" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold text-muted">Pilihan B</label>
                                    <input type="text" name="pilihan_b" class="form-control" value="<?= htmlspecialchars($data['pilihan_b']); ?>" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold text-muted">Pilihan C</label>
                                    <input type="text" name="pilihan_c" class="form-control" value="<?= htmlspecialchars($data['pilihan_c']); ?>" required>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label fw-semibold text-muted">Pilihan D</label>
                                    <input type="text" name="pilihan_d" class="form-control" value="<?= htmlspecialchars($data['pilihan_d']); ?>" required>
                                </div>
                            </div>
                            ...
                            <button type="submit" name="update" class="btn btn-pink px-4 fw-bold">Update Data</button>
